...
/***/ function(module, exports) {
	...
	var _user$project$Messages$Go = function (a) {
		return {ctor: 'Go', _0: a};
	};
	var _user$project$Messages$SelectCat = function (a) {
		return {ctor: 'SelectCat', _0: a};
	};
	var _user$project$Messages$ListCats = {ctor: 'ListCats'};

	var _user$project$Nav_Models$Cat = function (a) {
		return {ctor: 'Cat', _0: a};
	};
	var _user$project$Nav_Models$Home = {ctor: 'Home'};

	var _user$project$Models$cats = _elm_lang$core$Native_List.fromArray(
		[
			{id: 0, name: 'John', profilePicture: 'http://placekitten.com/400/400'},
			{id: 1, name: 'Lisa', profilePicture: 'http://placekitten.com/g/400/400'}
		]);
	var _user$project$Models$initialModel = {catList: _user$project$Models$cats, currentPage: _user$project$Nav_Models$Home, selectedCatId: 0};
	var _user$project$Models$emptyCat = {id: 0, name: '', profilePicture: ''};
	var _user$project$Models$Cat = F3(
		function (a, b, c) {
			return {id: a, name: b, profilePicture: c};
		});
	var _user$project$Models$Model = F3(
		function (a, b, c) {
			return {catList: a, currentPage: b, selectedCatId: c};
		});

	var _user$project$Nav_Parser$pageParser = _evancz$url_parser$UrlParser$oneOf(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_evancz$url_parser$UrlParser$format,
				_user$project$Nav_Models$Home,
				_evancz$url_parser$UrlParser$s('')),
				A2(
				_evancz$url_parser$UrlParser$format,
				_user$project$Nav_Models$Cat,
				A2(
					_evancz$url_parser$UrlParser_ops['</>'],
					_evancz$url_parser$UrlParser$s('cat'),
					_evancz$url_parser$UrlParser$int))
			]));
	var _user$project$Nav_Parser$pathParser = function (location) {
		return A3(
			_evancz$url_parser$UrlParser$parse,
			_elm_lang$core$Basics$identity,
			_user$project$Nav_Parser$pageParser,
			A2(_elm_lang$core$String$dropLeft, 1, location.pathname));
	};
	var _user$project$Nav_Parser$urlParser = _elm_lang$navigation$Navigation$makeParser(_user$project$Nav_Parser$pathParser);
	var _user$project$Nav_Parser$toPath = function (page) {
		var _p0 = page;
		if (_p0.ctor === 'Home') {
			return '/';
		} else {
	...
	var _user$project$Nav_Update$urlUpdate = F2(
			...
			if (_p0.ctor === 'Err') {
				return {
					...
					_1: _elm_lang$navigation$Navigation$modifyUrl(
						_user$project$Nav_Parser$toPath(model.currentPage))
				};
			} else {
				var _p2 = _p0._0;
				var _p1 = _p2;
				if (_p1.ctor === 'Cat') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{currentPage: _p2, selectedCatId: _p1._0}),
						_elm_lang$core$Native_List.fromArray(
							[]));
				} else {
					return A2(
	...
	var _user$project$Update$update = F2(
		function (msg, model) {
			...
			switch (_p0.ctor) {
				case 'ListCats':
					return {ctor: '_Tuple2', _0: _user$project$Models$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
				case 'SelectCat':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _elm_lang$navigation$Navigation$newUrl(
							_user$project$Nav_Parser$toPath(
								_user$project$Nav_Models$Cat(_p0._0)))
					};
				default:
					return {
						ctor: '_Tuple2',
	...
	var _user$project$View$clickTo = function (path) {
		return _elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$Json_Decode$map,
					function (_p0) {
						return _user$project$Messages$Go(path);
					},
					_elm_lang$core$Json_Decode$value))
			]);
	};
	var _user$project$View$catCard = function (cat) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'margin-bottom', _1: '0.5rem'},
							{ctor: '_Tuple2', _0: 'cursor', _1: 'pointer'},
							{ctor: '_Tuple2', _0: 'text-decoration', _1: 'underline'}
						])),
					_elm_lang$html$Html_Events$onClick(
					_user$project$Messages$SelectCat(cat.id))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(cat.name)
				]));
	};
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[]),
						A2(_elm_lang$core$List$map, _user$project$View$catCard, model.catList))
					]));
		} else {
			var cat = A2(
				_elm_lang$core$Maybe$withDefault,
				_user$project$Models$emptyCat,
				_elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (cat) {
							return _elm_lang$core$Native_Utils.eq(cat.id, model.selectedCatId);
						},
						model.catList)));
			return A2(
				_elm_lang$html$Html$div,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$src(cat.profilePicture)
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							])),
						...
						_user$project$View$clickTo(
							_user$project$Nav_Parser$toPath(_user$project$Nav_Models$Home)),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Back to cat list')
							]))
					]));
		}
	};
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'padding', _1: '0 1rem'}
						]))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
	...
	var _user$project$Main$init = function (result) {
		...
		return A2(_user$project$Nav_Update$urlUpdate, result, _user$project$Models$initialModel);
	};
	var _user$project$Main$main = {
		main: A2(
			_elm_lang$navigation$Navigation$program,
			_user$project$Nav_Parser$urlParser,
			{init: _user$project$Main$init, view: _user$project$View$view, update: _user$project$Update$update, urlUpdate: _user$project$Nav_Update$urlUpdate, subscriptions: _user$project$Subscriptions$subscriptions})
	};
