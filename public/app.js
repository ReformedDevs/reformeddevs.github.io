...
/***/ function(module, exports) {
	...
	var _user$project$Models$newAppModel = F2(
		function (route, location) {
			return {location: location, route: route};
		});
	var _user$project$Models$AppModel = F2(
		function (a, b) {
	...
	var _user$project$Routing_Config$matcherHome = A2(_sporto$hop$Hop_Matchers$match1, _user$project$Models$HomeRoute, '');
	var _user$project$Routing_Config$matchers = _elm_lang$core$Native_List.fromArray(
		[_user$project$Routing_Config$matcherHome]);
	var _user$project$Routing_Config$config = {basePath: '/', hash: false, matchers: _user$project$Routing_Config$matchers, notFound: _user$project$Models$NotFoundRoute};

	var _user$project$Messages$ShowHome = {ctor: 'ShowHome'};

	var _user$project$Routing_Utils$reverse = function (route) {
		var _p0 = route;
	...
	var _user$project$Update$routerConfig = _user$project$Routing_Config$config;
	var _user$project$Update$navigationCmd = function (path) {
		return _elm_lang$navigation$Navigation$newUrl(
			A2(_sporto$hop$Hop$makeUrl, _user$project$Routing_Config$config, path));
	};
	var _user$project$Update$update = F2(
		function (message, model) {
			var _p0 = A2(_elm_lang$core$Debug$log, 'message', message);
			var _p1 = A2(_elm_lang$core$Debug$log, 'model', model);
			var path = _user$project$Routing_Utils$reverse(_user$project$Models$HomeRoute);
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Update$navigationCmd(path)
			};
		});
	...
	var _user$project$View$title = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'color', _1: 'rgb(75, 75, 75)'},
	...
	var _user$project$View$pageView = function (model) {
		...
		if (_p0.ctor === 'HomeRoute') {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col-12'),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('col-12 flex justify-center')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$style(_user$project$View$title)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('The Reformed Devs')
									]))
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('col-4 mx-auto')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
	...
	var _user$project$View$baseStyles = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'min-height', _1: '100vh'},
			{ctor: '_Tuple2', _0: 'background-color', _1: 'rgb(250, 250, 250)'}
		]);
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$style(_user$project$View$baseStyles)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
	...
	var _user$project$Main$urlUpdate = F2(
		function (_p2, model) {
			var _p3 = _p2;
			var _p5 = _p3._1;
			var _p4 = A2(_elm_lang$core$Debug$log, 'urlUpdate location', _p5);
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{route: _p3._0, location: _p5}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		});
	var _user$project$Main$urlParser = _elm_lang$navigation$Navigation$makeParser(
		function (_p6) {
			return A2(
				...
				_user$project$Routing_Config$config,
				function (_) {
					return _.href;
				}(_p6));
		});
